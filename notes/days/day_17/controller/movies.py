...
@NS.route("")
class MoviesCollection(Resource):  #ask dean why you had to switch the delete methods
...
class Movie(Resource):
    ...
    # def delete(self, name):
    #     """ Deletes multiple movies by the same name """
    #     return Movies().delete_many(name)
